...
//     if (!course.disorder_name) return "Title is required.";
//     if (!course.disorder_short_desc) return "Author is required.";
//     if (!course.disorder_full_desc) return "Category is required.";
//     return "";
// }
